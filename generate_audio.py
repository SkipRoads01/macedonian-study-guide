...
# City & Directions tab — places on the Skopje map, the way to ask, the way to answer.
CITY_PLACES = ["хотел","црква","парк","зоолошка градина","ресторан","кафана","кафуле",
    "музеј","плоштад","тврдина","автобуска станица","чаршија","пазар","маркет","станица"]
DIRECTIONS = ["лево","десно","право","блиску","далеку","па","потоа",
    "Извинете, каде е музејот?","Извинете, каде е ресторанот?","Каде е станицата?",
    "Каде е кафулето?","Каде се станиците?","Каде се кафулињата?","Блиску е?","Далеку е?",
    "Како да стигнам до плоштадот?","Оди право.","Оди лево.","Оди десно.",
    "Оди право, па лево.","Потоа, оди десно.","Одете право.","Сврти лево.","Сврти десно.",
    "Блиску е.","Далеку е.","Не знам, жал ми е."]
# The definite article — same nouns with "the" stuck on the end.
DEFINITE = ["ресторанот","музејот","станицата","кафулето","станиците","кафулињата",
    "зоолошката градина","плоштадот"]
# Weather + the ќе future.
WEATHER = ["време","дожд","снег","сонце","ветер","Какво е времето?","Врне.","Врне дожд.",
    "Врне снег.","Сончево е.","Облачно е.","Дува ветер.","Топло е.","Студено е.",
    "Убаво време.","Немам време."]
FUTURE = ["патува","стигне","сврти","врне","Каде ќе одиш?","Ќе одам во Охрид.",
    "Ќе патувам утре.","Со кого ќе патуваш?","Ќе врне утре.","Нема да одам.",
    "Ќе врне.","Нема да работам утре.","патувам","стигнам"]
...
for group in (ALPHABET, NUMBER_WORDS, NUMBER_SENTENCES, QUIZ_VOCAB, QUIZ_PLURALS, QUIZ_VERBS,
              ...
              CITY_PLACES, DIRECTIONS, DEFINITE, WEATHER, FUTURE):
    for w in group:
        if w not in seen:
